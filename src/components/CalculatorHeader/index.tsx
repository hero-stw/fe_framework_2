...
import { savePercent, saveStart } from "@/store/slice/resultSlice";
        ...
        <div className={style.calculator__option}>
          <div className={style.calculator__option__item}>
            ...
            <select
              ...
              onChange={(event) => dispatch(saveAddition(event.target.value))}
            >
            ...
            <label htmlFor="addend">
              <input
                ...
                value={percent}
                id="margin"
                onInput={(event) => dispatch(savePercent(event.target.value))}
              />
            </label>
          </div>
        </div>
