                            ...
                            <tbody>
                                {
                                    calculation.map((item, index) => (
                                        <tr key={index} className='relative h-2 w-2'>
                                            ...
                                            {total.map((data: any) => (
                                                item === data.calculator ? <>
                                                    <td className='absolute' style={{ marginLeft: "70px", marginTop: "-40px" }} >{data.correctResult == 0 ? null : numDot(data.correctResult)}</td>
                                                    <td className='absolute' style={{ marginLeft: "270px", marginTop: "-40px" }}>{data.marginOfError == 0 ? "" : l100(roundTo2(data.marginOfError))}</td>
                                                </> : null
                                            ))}
                                        </tr>
                                    ))
